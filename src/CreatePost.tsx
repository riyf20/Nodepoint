...
import { UploadIcon, type UploadHandle } from "./components/ui/animatedIcons/upload-icon";
  ...
  return (
    <div className="flex flex-col w-full items-center justify-center pb-25">
      <div className=" w-[90%] mt-6 items-center justify-center">
        ...
        <div className="border border-[#27B1FC]/30 transition-all duration-250 transform hover:border-[#27B1FC]/60 bg-[#171718] mt-4 p-4 flex flex-col gap-6 rounded-2xl">
          <Field>
            <FieldLabel
              htmlFor={`input-field-title`}
              className={`text-[18px] font-bold transition-all duration-350 ${titleInvalid && "text-red-500"} `}
            >
            ...
            <Input
              ...
              className={`bg-[#1E1E20] transition-all duration-350 ${titleInvalid ? "border-red-500 focus-visible:ring-red-500" : ""} `}
            />
          </Field>
          ...
          <Field>
            <FieldLabel
              htmlFor={`input-field-title`}
              className={`text-[18px] font-bold transition-all duration-350 ${bodyInvalid && "text-red-500"} `}
            >
            ...
            <Textarea
              ...
              rows={12}
              className={`bg-[#1E1E20] transition-all duration-350 ${bodyInvalid ? "border-red-500 focus-visible:ring-red-500" : ""} `}
            />
          </Field>
          ...
          <FieldLabel
            htmlFor={`media`}
            className={`text-[18px] font-bold transition-all duration-350 `}
          >
            Upload Pictures
          </FieldLabel>
                  ...
                  >
                    <DialogTrigger asChild>
                      <img
                        src={url}
                        alt={`Preview ${index}`}
                        className="w-32 h-32 object-cover rounded-lg cursor-pointer hover:-translate-y-0.5 hover:scale-[1.03] transition-all duration-350 border border-white/16 shadow-xl"
                      />
                    </DialogTrigger>
                    ...
                    <DialogContent className="sm:max-w-md bg-white/10 backdrop-blur-md border-transparent">
                      ...
                      <DialogFooter className="flex">
                        ...
                        <Button
                          ...
                          className="w-full text-destructive hover:bg-destructive/30 [&_svg]:text-destructive hover:-translate-y-0.5 hover:scale-[1.03] transition-all duration-350"
                          onMouseEnter={() => {
          ...
          <Button
            variant="default"
            className="bg-[#1E1E20] w-[20%] hover:-translate-y-0.5 hover:scale-[1.03] transition-all duration-350 border border-white/7 shadow-xl"
            onClick={() => {
          ...
          >
            ...
            {images.length > 0 ? "Add More Files" : "Browse Files"}
          </Button>

          <Button
            variant="default"
            className="self-center w-[10%] border-2 border-[#27B1FC]/70 bg-[#27B1FC]/80 hover:bg-[#27B1FC]/70"
            onClick={handlePost}
          >
            Post
          </Button>
